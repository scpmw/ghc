...
mkRecSelBind (tycon, sel_name)
  ...
  where
    ...
    mk_match con = mkSimpleMatch [L sel_loc (mk_sel_pat con)] 
                                 (L sel_loc (HsVar field_var))
    mk_sel_pat con = ConPatIn (L sel_loc (getName con)) (RecCon rec_fields)
