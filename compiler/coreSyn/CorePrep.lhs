...
--
-- It might seem counter-intuitive to float ticks per default, given
...
-- when they pass through ticks, we might do the following
-- transformation:
--
...
-- into the floating binds (here "a") in cpePair.
